...
import com.wordnik.swagger.discover.Health
import com.wordnik.swagger.discover.HealthSnapshot
...
object AdminController extends SwaggerBaseApiController {
  override protected def jaxbContext(): JAXBContext = JAXBContext.newInstance(classOf[Health])
  val LOGGER = LoggerFactory.getLogger(AdminController.getClass)
